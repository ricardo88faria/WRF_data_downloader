...
data_i <- "2006-08-18" #readline(prompt = "Data inicial para analise de dados no formato (AAAA-MM-DD): ")
data_f <- "2006-08-21" #readline(prompt = "Data final para analise de dados no formato (AAAA-MM-DD): ")
